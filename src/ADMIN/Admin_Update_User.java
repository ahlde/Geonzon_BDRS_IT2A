...
public class Admin_Update_User extends javax.swing.JFrame {
    ...
    public void loadUser(int selectedUserId) {
        ...
        String query = "SELECT first_name, last_name, email, username, role, password FROM users WHERE user_id = ?";
        ...
        try (Connection conn = new dbconnect().getConnection();
            ...
            try (ResultSet rs = pst.executeQuery()) {
                if (rs.next()) {
                    ...
                    password.setText(rs.getString("password")); // or use password.setText(...) only if secure
                } else {
            ...
            JOptionPane.showMessageDialog(this, "Error loading user: " + e.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 290, 30));
        ...
        jPanel3.add(firstname, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 290, 40));
        ...
        jPanel3.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 290, 40));

        jLabel8.setBackground(new java.awt.Color(13, 16, 63));
        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("First Name");
        jPanel3.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 290, 30));
        ...
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 710, 40));
        ...
        jPanel3.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, 290, 40));

        jLabel10.setBackground(new java.awt.Color(13, 16, 63));
        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Last Name");
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, 290, 30));
        ...
        jPanel3.add(lastname, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 290, 40));

        jLabel11.setBackground(new java.awt.Color(13, 16, 63));
        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Role");
        jPanel3.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 290, 30));
        ...
        jPanel3.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 290, 40));

        jLabel12.setBackground(new java.awt.Color(13, 16, 63));
        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Email");
        jPanel3.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, 290, 30));
        ...
        jPanel3.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 290, 40));

        role.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Role", "Admin", "User" }));
        jPanel3.add(role, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, 290, 40));

        jLabel13.setBackground(new java.awt.Color(13, 16, 63));
        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Username");
        jPanel3.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 290, 30));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 710, 380));
    ...
    private void saveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveMouseClicked
        ...
        try (Connection conn = new dbconnect().getConnection()) {
            String sql = "UPDATE users SET first_name = ?, last_name = ?, email = ?, username = ?, role = ?, password = ? WHERE user_id = ?";
            ...
            if (rows > 0) {
                ...
                this.dispose(); // Close window if desired
            } else {
    ...
    private void backMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backMouseClicked
        Admin_Account back = new Admin_Account();
