...
public class Admin_Add_User extends javax.swing.JFrame {
    ...
    private boolean isUsernameDuplicate(String username) {
        ...
        private boolean validateFieldsWithoutConfirm() {
        if (firstname.getText().isEmpty() ||
            lastname.getText().isEmpty() ||
            role.getSelectedItem() == null ||
            email.getText().isEmpty() ||
    ...
    private void initComponents() {
        ...
        jPanel3.add(create, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, 290, 40));
    ...
    private void createMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createMouseClicked
        if (!validateFieldsWithoutConfirm()) return;
        ...
        try (Connection conn = dbc.getConnection()) {
            ...
            final String insertSQL =
                "INSERT INTO users (first_name, last_name, email, username, password, role, status) VALUES (?,?,?,?,?,?,?)";
            ...
            try (PreparedStatement psInsert = conn.prepareStatement(insertSQL)) {
                ...
                psInsert.setString(7, "Inactive"); // By default inactive

                int rows = psInsert.executeUpdate();
                if (rows > 0) {
                    JOptionPane.showMessageDialog(this,
                        "User created successfully! Awaiting activation.",
                        "✅ Success", JOptionPane.INFORMATION_MESSAGE);
                    // Optional: reset fields or refresh table
                } else {
                    JOptionPane.showMessageDialog(this,
