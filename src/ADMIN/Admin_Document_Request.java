...
public class Admin_Document_Request extends javax.swing.JFrame {

    public Admin_Document_Request() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("DOCUMENT REQUEST");
        docsPanel.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 180, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Document_Request.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Document_Request().setVisible(true);
            }
        });
    }
